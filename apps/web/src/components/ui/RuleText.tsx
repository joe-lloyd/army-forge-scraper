// Shared rule renderer with hover-tooltip support. Used by the explorer,
// analyzer, and comparison views so common-rules tooltips appear consistently.
//
// The dict is name → description. Army-book-specific rules (faction rules)
// can be merged on top of the common-rules dict, so the dict only carries
// what the consumer wants surfaced.
...
export function RuleList({
  ...
  rules: { name?: string; label?: string; rating?: string | number }[];
  specialRulesDict?: Record<string, string>;
}) {
